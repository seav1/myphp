...
";
        ...
        if ($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "settings"), "cdn_core")) {
           ...
           $context["core_js"] = ("/app/public/js/3.30.1/x3.min.js");
            // line 28
            echo "\t";
            $context["core_css"] = (((("https://cdn.only4test.win/npm/x3.photo.gallery@" . $this->getAttribute((isset($context["page"]) ? $context["page"] : null), "x3_version")) . "/css/x3.skin.") . $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "style"), "skin"), "skin")) . ".css");
        } else {
            // line 30
            echo "\t";
